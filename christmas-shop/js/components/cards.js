...
function giftCreated( data){
  ...
  const card = new Component(
    ...
    new Component({ className: 'card-footer' },
      new Component({tag:"span", className:'card-category',text:data.category}),
      new Component({tag:"span",className:'card-description',text:data.name})
    )
...
export  {container,wrapperGiftToHomePage,gifts};